...
def record_tool_result(ctx: "AuthContext", result: dict[str, Any]) -> None:
    ...
    # Decimal identifier kept as a string: trace backends type attributes, and a
    # field that is sometimes int and sometimes string is painful to query later.
...
def _set_permission_denied_attributes(
    ...
    """
    # result.get, not result["error"]: success dicts carry no "error" key.
